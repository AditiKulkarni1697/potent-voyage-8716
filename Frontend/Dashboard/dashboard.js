...
fetch(`http://localhost:9090/timer/data/${formattedStartDate}/${formattedEndDate}`)
.then((res)=>{
  return res.json()
})
.then((data)=>{
...
$(function() {
    $('input[name="daterange"]').daterangepicker({
     ...
     data1.width=arr
     bargraph(data1)
     var dateRangefordata = getDateRange(start.format('YYYY-MM-DD'),end.format('YYYY-MM-DD'));
